        ...
        <View style={styles.section}>
          ...
          <View style={styles.overviewGrid}>
            <View style={styles.overviewItem}>
              <View
                style={[styles.overviewDot, { backgroundColor: "#10b981" }]}
              />
            ...
            <View style={styles.overviewItem}>
              <View
                style={[styles.overviewDot, { backgroundColor: "#f59e0b" }]}
              />
            ...
            <View style={styles.overviewItem}>
              <View
                style={[styles.overviewDot, { backgroundColor: "#ef4444" }]}
              />
              <Text style={styles.overviewLabel}>Faulty</Text>
              <Text style={styles.overviewValue}>
                {" "}
                {healthSummary?.faultyCount || 0}{" "}
              </Text>
            </View>
          </View>
